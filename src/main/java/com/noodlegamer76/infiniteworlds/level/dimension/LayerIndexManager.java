...
public class LayerIndexManager {
    ...
    @Nullable
    public LevelChunk getChunkAt(StackedChunkPos pos, ServerLevel baseLevel) {
        ...
        return layerLevel.getChunk(layerPos.x, layerPos.z);
    }
    ...
    public LayerIndex createNewLayerIndex(StackedChunkPos stackedPos, int sectionHeight) {
        ...
        LayerIndex index = new LayerIndex(stackedPos, layerPos, sectionHeight);
        savedData.putLayer(stackedPos, index);
